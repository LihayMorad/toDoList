...
public class UtilityFunctions  {
    ...
    public static void EmailValidation (String emailStr) throws  IllegalArgumentException {
        emailStr=emailStr.trim();
        Matcher checker = VALID_EMAIL_ADDRESS_REGEX .matcher(emailStr);
        if(checker.matches())
            throw new IllegalArgumentException("Inappropriate e-mail format\n");
    }
