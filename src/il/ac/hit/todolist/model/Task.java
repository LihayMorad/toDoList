...
//Hibernate class defining an appropriate table in DB ( in this case tasks table)
public class Task extends DBObject {
    ...
    public Task() { // default constructor
        this(00, 00, "", false, ""); // default values
    }
...
//        UtilityFunctions.OnlyLettersNumbersAndSpaces(description);
    ...
    @Override
    public String toString() { // The returned string is a  line from Tasks table
        return "Task{" +
                "taskID=" + taskID +
                ", listID=" + listID +
